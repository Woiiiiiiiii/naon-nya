        ...
        try:
            ...
            def make_frame(t):
                ...
                if scene_id == 'hook' and scene_t > 0.3:
                    ...
                    ty = text_slide_up(hero_img, H, 1370, scene_t - 0.8, 0.4)
                    ...
                    if scene_t > 3.0:
                        # Position bubble2 below bubble1 using cached height
            ...
            scene_starts = {'hook': 0.5, 'feature': 13.0, 'proof': 31.0, 'cta': 41.0}
